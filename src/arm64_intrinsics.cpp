...
public:
  ...
  virtual vector<Confidence<Ref<Type>>>
  ...
  virtual bool GetInstructionLowLevelIL(const uint8_t *data, uint64_t addr,
    ...
    case ISB:
      il.AddInstruction(
          il.Intrinsic(vector<RegisterOrFlag>{}, ISB, vector<ExprId>{}));
      break;
    case WFI:
      il.AddInstruction(
          il.Intrinsic(vector<RegisterOrFlag>{}, WFI, vector<ExprId>{}));
      break;
    case WFE:
      il.AddInstruction(
          il.Intrinsic(vector<RegisterOrFlag>{}, WFE, vector<ExprId>{}));
      break;
    case MSR_REG: {
